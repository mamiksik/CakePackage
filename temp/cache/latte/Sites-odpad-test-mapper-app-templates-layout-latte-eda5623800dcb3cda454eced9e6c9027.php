<?php
// source: /Users/martin/Sites/odpad/test-mapper/app/templates/@layout.latte

// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('2348048746', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block head
//
if (!function_exists($_b->blocks['head'][] = '_lbdcf94481fe_head')) { function _lbdcf94481fe_head($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
;
}}
...
// block scripts
//
if (!function_exists($_b->blocks['scripts'][] = '_lb69ec9951cf_scripts')) { function _lb69ec9951cf_scripts($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
