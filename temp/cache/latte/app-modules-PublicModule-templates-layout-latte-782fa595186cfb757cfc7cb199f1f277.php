<?php
// source: /Users/martin/Sites/odpad/test-mapper/app/modules/PublicModule/templates/@layout.latte

// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('3584352796', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block head
//
if (!function_exists($_b->blocks['head'][] = '_lb14dcea3c30_head')) { function _lb14dcea3c30_head($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
;
}}
...
// block scripts
//
if (!function_exists($_b->blocks['scripts'][] = '_lb05cedac637_scripts')) { function _lb05cedac637_scripts($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
