<?php
// source: /Users/martin/Sites/odpad/test-mapper/app/templates/Homepage/default.latte

// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('8439685918', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lbe63e4cc89b_content')) { function _lbe63e4cc89b_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><div id="banner">
...
// block title
//
if (!function_exists($_b->blocks['title'][] = '_lbc25227a979_title')) { function _lbc25227a979_title($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block scripts
//
if (!function_exists($_b->blocks['scripts'][] = '_lb3c0674baa7_scripts')) { function _lb3c0674baa7_scripts($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block head
//
if (!function_exists($_b->blocks['head'][] = '_lb257f44ea65_head')) { function _lb257f44ea65_head($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><style>
